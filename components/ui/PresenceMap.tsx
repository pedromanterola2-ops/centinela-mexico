    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_280px]">
      ...
      <div className="rounded-lg border border-border bg-bg-surface p-4 sm:p-6">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2">
          <span className="font-mono text-xs uppercase tracking-wider text-text-muted/70">
            Menos
          </span>
          {[1, 2, 3, 5, 7].map((s) => (
        ...
        {sel ? (
          <div>
            <div className="flex items-start justify-between gap-2">
              ...
              {sel.pendiente && (
                <span className="shrink-0 rounded-sm border border-amber-500/30 bg-amber-500/10 px-1.5 py-0.5 font-mono text-[11px] uppercase tracking-wider text-amber-400/90">
                  En verificación
                </span>
              )}
            </div>
            ...
            <dl className="mt-4 space-y-3 text-base">
              <div>
                <dt className="font-mono text-xs uppercase tracking-wider text-text-muted/70">
                  Región militar
                </dt>
            ...
            <Link
              ...
              className="mt-5 inline-block rounded-sm bg-green-500/10 border border-green-500/20 px-3 py-2 text-sm font-medium text-green-400 transition-colors hover:bg-green-500/20"
            >
          ...
          <div className="flex h-full flex-col items-center justify-center text-center">
            ...
            <p className="mt-3 font-mono text-xs text-text-muted/50">
