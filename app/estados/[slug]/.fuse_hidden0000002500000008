        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {estado.zona_militar && (
            <div className="rounded-lg border border-border bg-bg-surface p-4">
              ...
              <p className="text-sm text-text">{estado.zona_militar}</p>
            </div>
          )}
          {estado.region_militar && (
            <div className="rounded-lg border border-border bg-bg-surface p-4">
              ...
              <p className="text-sm text-text">{estado.region_militar}</p>
            </div>
          )}
          {estado.zona_naval && (
            <div className="rounded-lg border border-border bg-bg-surface p-4">
              ...
              <p className="text-sm text-text">{estado.zona_naval}</p>
            </div>
          )}
            ...
            <div className="rounded-lg border border-border bg-bg-surface p-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {estado.riesgos_principales.map((r) => (
                  <span
                    key={r}
                    className="inline-flex items-center rounded-md border border-amber-500/20 bg-amber-500/5 px-2.5 py-1 text-xs text-amber-400"
                  >
                    {r}
                  </span>
                ))}
