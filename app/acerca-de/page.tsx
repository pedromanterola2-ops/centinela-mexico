          ...
          {[
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-base font-semibold text-text">{p.titulo}</h3>
              </div>
      ...
      <section className="mb-10">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {SECCIONES.map((s) => (
            ...
            >
              <p className="text-base font-medium text-text group-hover:text-green-400 transition-colors mb-0.5">
                {s.label}
              </p>
              <p className="text-sm text-text-muted/70">{s.desc}</p>
            </Link>
          ))}
        </div>
      </section>
          ...
          {FUENTES.map((f) => (
            <li key={f.url} className="flex items-center gap-2">
              ...
              <a
                ...
                className="text-base text-text-muted hover:text-green-400 transition-colors"
              >
                {f.nombre}
              </a>
            </li>
