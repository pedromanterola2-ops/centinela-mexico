            ...
            <>
              ...
              {item.imagen_fuente && (
                <a
                  ...
                  className="absolute bottom-1 right-1.5 text-[11px] text-white/60 hover:text-white/90 bg-black/40 px-1 rounded z-10"
      ...
      {fuerza && (
        <section className="mb-8">
          ...
          >
            ...
            <div>
              <p className="text-base font-medium text-text group-hover:text-green-400 transition-colors">
                {fuerza.siglas ?? fuerza.nombre}
              </p>
              <p className="text-sm text-text-muted">Ver ficha institucional →</p>
            </div>
          </Link>
        </section>
      )}
