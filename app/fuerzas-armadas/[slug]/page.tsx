    ...
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <header className="flex items-start gap-4 pb-6 mb-6 border-b border-border">
        ...
        <div className="flex-1">
          ...
          {fuerza.siglas && (
            <p className="text-base text-text mb-1">{fuerza.nombre}</p>
          )}
      ...
      {equipamiento.length > 0 && (
        <section className="mb-8">
            ...
            {equipamiento.map((e) => (
              ...
              >
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  <span className="text-base font-medium text-text group-hover:text-green-400 transition-colors leading-snug">
                    {e.nombre}
                  </span>
                  <Badge variant="gris">
                ...
                {e.origen_pais && (
                  <p className="text-[13px] text-text-muted/70 font-mono">
                    {e.origen_pais}
                  </p>
                )}
              </Link>
          ...
          <p className="mt-2 text-[13px] text-text-muted/50">
